...
#------------------------------------------------------------------
# gallium nitride (GaN), wurtzite, ordinary, from S. Shokhovets. et al., Journal of Applied Physics, Vol. 94, no. 1, pp. 307-312, 2003
# ref: https://aip.scitation.org/doi/10.1063/1.1582369 
# wavelength range: 0.43 - 0.8 um

## NOTE: ordinary (o) axes in X and Y, extraordinary (e) axis in Z

GaN_range_Shokhovets = mp.FreqRange(min=um_scale/0.8, max=um_scale/0.43)

GaN_frq1_Shokhovets = 1/(0.3265*um_scale)
GaN_gam1_Shokhovets = 4.1e-10
GaN_sig1_Shokhovets = 0.9116

GaN_susc_o_Shokovets = [mp.LorentzianSusceptibility(frequency=GaN_frq1_Shokhovets, gamma=GaN_gam1_Shokhovets, sigma=GaN_sig1_Shokhovets)]

GaN_frq1 = 1/(18.76*um_scale)
GaN_gam1 = 0
GaN_sig1 = 5.08

GaN_susc_e_Shokhovets = [mp.LorentzianSusceptibility(frequency=GaN_frq1, gamma=GaN_gam1, sigma=GaN_sig1_Shokhovets)]

GaN = mp.Medium(epsilon=4.393, E_susceptibilities=GaN_susc_o_Shokovets+GaN_susc_e_Shokhovets, valid_freq_range=GaN_range_Shokhovets)
